...
<body>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/user/echarts.jsp')"> 用户统计</a>
                                </button><br><br>
                    ...
                    <div class="panel panel-warning">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <button class="btn btn-warning">视频信息</button>
                            </div>
                        </div>
                    </div>
    ...
    <!--栅格系统-->
    <!--页脚-->
    <div class="panel panel-footer" align="center" style="margin-top: 269px">
